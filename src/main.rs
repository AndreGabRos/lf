use std::{
    fs::{self, Metadata}, 
    os::unix::prelude::{PermissionsExt, MetadataExt}
};
use clap::Parser;
...
// fn set_print_color(files_name: &mut Vec<String>, file_mode: u32) {
//     for name in files_name.iter_mut() {
//         if name.ends_with('/') {
//             name.push(' ');
//             *name = Blue.paint(name.to_string()).to_string();
//         } else {
//             *name = set_print_color_by_ext_perm(name.to_string(), file_mode);
//         }
//     }
// }
